            ...
            <div className="action-buttons">
              ...
              >
                ...
                {product.stock === 0 ? 'Out of Stock' : 
                 isInCart(product.id) ? `In Cart (${getItemQuantity(product.id)})` : 
                 'Add to Cart'}
              </button>
            ...
            <div className="specifications-tab">
              ...
              <div className="specs-grid">
                ...
                <div className="spec-item">
                  ...
                  <span className="spec-value">{product.weight || 'N/A'} kg</span>
                </div>
                <div className="spec-item">
                ...
                <div className="spec-item">
                  ...
                  <span className="spec-value">{product.returnPolicy || '30 days return policy'}</span>
                </div>
              </div>
            </div>
          )}
              ...
              <div className="reviews-summary">
                <div className="rating-overview">
                  <div className="average-rating">
                    ...
                    <span className="total-reviews">Based on {Math.floor(Math.random() * 500) + 50} reviews</span>
                  </div>
                </div>
              </div>
