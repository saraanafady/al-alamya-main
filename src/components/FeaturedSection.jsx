  ...
  if (loading) {
    return (
      <section className="featured-section">
        <div className="featured-loading">Loading featured product...</div>
      </section>
    );
  }
      ...
      <div className="featured-content">
        ...
        <div className="featured-info">
          <div className="featured-info-inner">
            <span className="featured-stock-status">IN STOCK NOW</span>
            <h2>{product.title || "Featured Product"}</h2>
            <p>{product.description || "Elevate your audio experience with rich and powerful sound, seamlessly blending style and substance."}</p>
            <div className="featured-product-card" style={{ background: '#f7f7f7', borderRadius: '8px', padding: '1rem', margin: '2rem 0 0 0', display: 'flex', alignItems: 'left', maxWidth: '420px' }}>
              ...
              <span style={{ fontWeight: 600, fontSize: '1.1rem' }}>${product.price || '215.00'}</span>
            </div>
          </div>
        </div>
      </div>
